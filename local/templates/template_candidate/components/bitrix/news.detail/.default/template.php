...
<div class="vote-block">
    <p>Рейтинг: <strong id="vote-count"><?= $arResult['VOTES'] ?></strong></p>
    <?php if (!$arResult['USER_VOTED']): ?>
        <form method="post" style="display:inline;">
            <?= bitrix_sessid_post() ?>
            <input type="hidden" name="news_id" value="<?= $arResult['ID'] ?>">
            <button type="submit" name="vote" value="down">Проголосовать -</button>
            <button type="submit" name="vote" value="up">Проголосовать +</button>
        </form>
    <?php else: ?>
